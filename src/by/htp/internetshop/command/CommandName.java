...
public enum CommandName {
	...
	REMOVE_PRODUCT, CANCEL_THE_ORDER, LOG_OUT, NO_SUCH_COMMAND, CHOOSE_LANGUAGE, SHOW_CORRECT_CLIENTS, SHOW_BLACKLIST, SHOW_PRODUCTS, 
	SHOW_INFORMATION_ABOUT_PRODUCT, GO_ADD_PRODUCT, GO_EDIT_PRODUCT;
