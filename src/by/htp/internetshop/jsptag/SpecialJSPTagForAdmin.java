	...
	public int doStartTag() throws JspException {
		...
		try {
			for (Product product : productList) {
				...
				out.write("<input type=\"hidden\" name=\"command\" value=\"edit_product\" />");
				out.write("<input type=\"hidden\" name=\"id\" value=\"" + product.getId() + "\" />");
				out.write("<input type=\"submit\" value=\"" + nameedit + "\" />");
				out.write("</form>");
				out.write("</td>");
				out.write("<td>");
				out.write("<form action=\"controller\" method=\"post\">");
				out.write("<input type=\"hidden\" name=\"command\" value=\"delete_product\" />");
				out.write("<input type=\"hidden\" name=\"id\" value=\"" + product.getId() + "\" />");
